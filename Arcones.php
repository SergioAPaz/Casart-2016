...
$primera=<<<SQL
SELECT Titulo,Descripcion,urlimagen,Nuevo_producto FROM catalogo WHERE galeria='Arcones';
SQL;
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/Arcones.css">
    ...
    <script type="text/javascript" src="assets/js/Arcones.js"></script><!--scripts generales-->
        ...
        <div class="row">
            <div class="col-lg-12" >
                ...
                <div class="intro-text">
                    <span class="name" style="font-size: 40px">Arcones</span>
                    <hr class="star-light" >
                    <span class="skills">Gran surtido de deliciosos productos artesanales, ideal para un regalo especial.</span>
                </div>
            </div>
        </div>
    </div>
