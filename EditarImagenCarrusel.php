...
<div class="container">
    <div class="panel panel-default"style="margin-top: 15px">
        <div class="panel-body" >
            <p class="alert" style="font-size: 30px;background-color: #FFCA28;color: #ffffff">Cambiar imagen de carrusel</p>
            <form role="form" method="POST"  enctype="multipart/form-data" action="PHPCatalogo/EditarImagenCarruselCode.php">
