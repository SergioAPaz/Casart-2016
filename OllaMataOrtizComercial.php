...
<head>
    ...
    <link rel="stylesheet" href="assets/css/OllaMataOrtizComercial.css">
    ...
    <script type="text/javascript" src="assets/js/OllaMataOrtizComercial.js"></script><!--scripts generales-->
