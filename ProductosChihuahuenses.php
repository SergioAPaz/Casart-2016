...
$primera=<<<SQL
SELECT Titulo,Descripcion,urlimagen,Nuevo_producto FROM catalogo WHERE galeria='Productos Chihuahuenses';
SQL;
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/ProductosChihuahuenses.css">
    ...
    <script type="text/javascript" src="assets/js/ProductosChihuahuenses.js"></script><!--scripts generales-->
        ...
        <div class="row">
            <div class="col-lg-12" >
                ...
                <div class="intro-text">
                    <span class="name" style="font-size: 40px">Productos Chihuahuenses</span>
                    <hr class="star-light" >
                    <span class="skills">"Excelentes productos originarios de Chihuahua."</span>
                </div>
            </div>
        </div>
    </div>
