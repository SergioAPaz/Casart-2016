                ...
                <ul>
                    ...
                    <li class='active has-sub'><a href='#'>Productos</a>
                        <ul>
                            ...
                            <li ><a href='PanelAdmin.php'>Arcones</a></li>
                            <li ><a href='PanelLogin.php'>Artesania regional</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href='#'>Concursos</a>
            ...
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul class="children">
                        ...
                        <li><a href="PanelLogin.php"><span class="icon-ctrl"></span>Artesania Regional</a> </li>
                    </ul>
                </li>
                <li>
