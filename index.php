...
?>
    ...
    <head>
        ...
        <!--scripts generales-->
        <script type="text/javascript" src="assets/js/slideshow/jssor.js"></script>
        <!--slideshow-->
        <script type="text/javascript" src="assets/js/slideshow/jssor.slider.js"></script>
        <!--slideshow-->
    ...
    <body style="background-color: #795548">
        ...
        width: 1300px; /*height: 425px;*/ overflow: hidden;">
            ...
            while ($ColumnaSlideshow=mysqli_fetch_assoc($FilasSlideshow))
            {
                ...
                $Validate=preg_replace('[\s+]',"", $ColumnaSlideshow['LinkTo']);
                   echo "<a href='$Validate'>";
                        ...
                        echo "</picture>";
                   echo "</a>";
                    echo "<div class='text00' style='position: absolute; width: 480px; height: 120px; top: 30px; left: 30px; padding: 5px;text-align: left; line-height: 60px; text-transform: uppercase; color: #FFFFFF;text-shadow: 4px 4px 5px #222;'>$ColumnaSlideshow[Titulo]</div>";
                    echo "<div class='text11' style='position: absolute; height: 180px;left: 30px; padding: 5px;text-align: left; color: #FFFFFF; text-shadow: 2px 2px 3px black;'>$ColumnaSlideshow[Descripcion]</div>";
                echo "</div>";
            }
            ?>
                </div>
        ...
        <div class="container estilos2561">
            <div class="jumbotron estilos2562">
                ...
                <h2 class="tamano">Artesanías Mexicanas Tradicionales</h2>
        ...
        <div class="container-fluid" style="padding-right: 0;padding-left: 0">
            ...
            <div class="x2  col-lg-3 col-md-4 col-sm-6 col-xs-12" style="overflow: hidden;padding-left: 0;padding-right: 0">
                <div id="color3">
                    ...
                    display: none; text-align: center;margin-left: 4%;margin-right: 4%;   color: white;">Tradición de antaño, la fabricación de artesanías es fundamental para los tarahumaras, quienes siempre han destacado por sus minuciosos trabajos en cestería.
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="x2  col-lg-3 col-md-4 col-sm-6 col-xs-12" style="overflow: hidden;padding-left: 0;padding-right: 0">
                <div id="color4">
                 ...
                 display: none; text-align: center;margin-left: 4%;margin-right: 4%;   color: white;">Los pueblos Rarámuris realizan distintas actividades siempre acompañadas de música y sonidos que emiten los instrumentos que ellos mismos fabrican con materiales como cuero y madera.</div>
                    </a>
                </div>
            </div>
            ...
            <div class="x2  col-lg-3 col-md-4 col-sm-6 col-xs-12" style="overflow: hidden;padding-left: 0;padding-right: 0">
                <div id="color7">
                 ...
                 display: none; text-align: center;margin-left: 4%;margin-right: 4%;   color: white;">La cultura mexicana se distingue en el mundo por tener un sello propio, lleno de color, historia y autenticidad. Prueba de ello lo encontramos en el pueblo de Mata Ortiz.</div>
                    </a>
                </div>
            </div>
            ...
            <div class="x2  col-lg-3 col-md-4 col-sm-6 col-xs-12" style="overflow: hidden;padding-left: 0;padding-right: 0">
               ...
               display: none; text-align: center;margin-left: 4%;margin-right: 4%; top: 33%;  color: white;">Piezas artísticas de significación cultural realizadas manualmente por artesanos, piezas que reflejan una autenticidad que enorgullece y revitaliza la artesanía chihuahuense.</div>
                    </a>
                </div>
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row" style="background-color: #FFA726">
                ...
                <div class="col-xs-12 col-sm-8" style="background-color: #FFA726;">
                    ...
                    <p class="text-uppercase" style="font-size: 17px;color: #ffffff">La cerámica de Mata Ortiz es un estilo de artesanías, principalmente vasijas y ollas, iniciada en el poblado de Juan Mata Ortiz, Chihuahua. Toma su inspiración de la cerámica aridoamericana originada en Casas Grandes, para convertirse
                        en cuatro décadas en un estilo artesanal de gran reconocimiento, expuesto en galerías de arte y celebrado internacionalmente. Actualmente son más de 300 los artesanos dedicados a la producción de esta cerámica en Mata Ortiz.
                    </p>
                    <p class="text-uppercase hidden-xs hidden-sm hidden-md" style="font-size: 17px;color: #ffffff">
                        A la edad de 20 años, Juan Quezada Celado emprendía largas caminatas con su burro para colectar leña, fruta y miel de agave en las cercanías de su poblado natal, Juan Mata Ortiz. En estos viajes, Quezada recolectaba piezas y pedacería prehispánica proveniente
                        de la cultura Casas Grandes. Durante varios años, resultado de la observación de los colores y los patrones geométricos de la cerámica aridoamericana, fue perfeccionando su técnica, añadiendo un poco de arena en la mezcla para
                        evitar que se fragmentara.
                    </p>
                </div>
        ...
        <section style="position: relative">
            <a name="cmntanchor">
                <section id="footer" class=" aqui cmntanchor" style="color: #FAFAFA">
            </a>
            ...
            <div class="inner">
                ...
                <ul class="contact" style="margin-top: 15px">
                    <li class="fa-home">
                        Calle 4ta <br /> Col. Villas del real<br /> Chihuahua, Chihuahua,<br /> México 31000
                    </li>

                    <li class="fa-phone">Cel: (614) 4-47-48-59</li>
                    <li class="fa-envelope"><a>Alejandroax@live.com.mx</a></li>
                    <li class="fa-envelope"><a>casartchihuahua@gmail.com</a></li>
                </ul>
            ...
            <footer>
                <div class="container-fluid margintop">
                    <div class="row" style="background-color: #3E2723;height: auto">
                        ...
                        <div>
                            <p style="color:#212121;background-color: #FAFAFA;padding: 20px;font-size: 14px;margin: 0">© Casa de las Artesanías del Estado de Chihuahua, proyecto escolar ajeno a Casart.
