...
<head>
    ...
    <link rel="stylesheet" href="assets/css/OllaEconomica.css">
    ...
    <script type="text/javascript" src="assets/js/OllaEconomica.js"></script><!--scripts generales-->
...
<div class="container-fluid" style="">
    <div class="row">
        <div class="col-xs-12" style="padding-right: 0;padding-left: 0">
            <picture>
                <source  srcset="images/olla_xl.JPG" media="(min-width: 769px)"  class="img-responsive"alt="Responsive image">
                <img  srcset="images/olla_sm.JPG" class="img-responsive" id="id10"  alt="Responsive image" >
            </picture>
            <div class="pull-right hidden-xs id20" id="id20" style="position: absolute">
                <p style="color: #FAFAFA;font-size: 30px">Ceramica de Mata Ortiz</p>
                <p style="color: #ffffff;font-size: 17px">La cerámica de Mata Ortiz es un estilo de artesanías, principalmente vasijas y ollas, iniciada por Juan Quezada Celado en el poblado de
                    Juan Mata Ortiz, Chihuahua. Toma su inspiración de la cerámica aridoamericana originada en Casas Grandes, para convertirse en cuatro décadas
                    en un estilo artesanal de gran reconocimiento, expuesto en galerías de arte y celebrado internacionalmente. </p>
                <p class="hidden-sm" style="color: #ffffff;font-size: 17px">Actualmente son más de 300 los artesanos dedicados a la producción de esta cerámica en Mata Ortiz. </p>
            </div>
        </div>
    </div>
</div>
